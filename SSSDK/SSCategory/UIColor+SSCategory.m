...
{
    @autoreleasepool {
        NSString *cleanString_1 = [string stringByReplacingOccurrencesOfString:@"#" withString:@""];
...
+ (instancetype)colorGradientFrameSize:(CGSize)size direction:(SSColorGradientDirection)direction startColor:(UIColor *)startcolor endColor:(UIColor *)endColor
{
    ...
    if (direction == SSColorGradientDirectionDownDiagonalLine) {
    ...
    switch (direction) {
        case SSColorGradientDirectionLevel:
            endPoint = CGPointMake(1.0, 0.0);
            break;
        case SSColorGradientDirectionVertical:
            endPoint = CGPointMake(0.0, 1.0);
            break;
        case SSColorGradientDirectionUpwardDiagonalLine:
            endPoint = CGPointMake(1.0, 1.0);
            break;
        case SSColorGradientDirectionDownDiagonalLine:
            endPoint = CGPointMake(1.0, 0.0);
            break;
        default:
            break;
